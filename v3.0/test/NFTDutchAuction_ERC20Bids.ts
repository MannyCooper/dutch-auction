...
import { ERC20Mock, NFTDutchAuction_ERC20Bids } from "../typechain-types";
import { Signer } from "ethers";

describe("NFTDutchAuction_ERC20Bids", function () {
  let NFTDutchAuction: NFTDutchAuction_ERC20Bids;
  ...
  beforeEach(async function () {
    ...
    erc20Token = await ERC20Mock.deploy("Token", "TKN");
